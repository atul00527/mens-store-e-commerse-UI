    ...
    <section className="relative h-[70vh] md:h-[90vh] bg-cover bg-center flex items-center" style={{ backgroundImage: `url(${hero})` }}>
        ...
        <div className="relative z-10 px-4 sm:px-8 md:pl-10 max-w-full md:max-w-2xl text-white w-full">
            ...
            <h1 className="text-4xl md:text-6xl font-extrabold leading-tight capitalize">
                Elevate Your Style with <span className="text-gray-700">FabrikFit</span>
            </h1>
            ...
            <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                <button className="bg-gray-700 text-white font-bold px-6 py-3 cursor-pointer rounded-full hover:bg-gray-800 transition">
                    Shop Now
                </button>
                <button className="border border-white px-6 py-3 rounded-full cursor-pointer hover:bg-white hover:text-gray-700 hover:font-bold transition">
                    Explore Collections
                </button>
            </div>
        </div>
